...
const loadSchedule = async () => {
  ...
  try {
    loading.value = true
    const response = await fetch(`https://glut-schedule-api.vercel.app/api/schedule?username=${encodeURIComponent(username)}&password=${encodeURIComponent(password)}&date=${selectedDate.value}`)
